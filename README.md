...
This is the standard launch flag for personal-assistant use; it lets Claude write files in your folder without asking for each one. It only affects this folder.
...
2. Create `AGENTS.md` and the `agy/` folder structure in your folder.
