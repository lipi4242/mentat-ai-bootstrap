...
Ez a személyes asszisztens-használat szokásos indítási jelzője; lehetővé teszi, hogy Claude fájlokat írjon a mappádba anélkül, hogy minden alkalommal megkérdezné. Csak ezt a mappát érinti.
...
7. **Keretrendszerek** — egy sor mindegyikre + URL a részletes fájlra a `https://raw.githubusercontent.com/lipi4242/mentat-ai-bootstrap/main/reference/frameworks/` címen. Lista: Pyramid Principle, 80/20 szabály, MECE, First Principles, Say It With Charts (Zelazny), Mentat-gondolkodás. NINCS beágyazott magyarázat — csak link.
...
`https://raw.githubusercontent.com/lipi4242/mentat-ai-bootstrap/main/reference/intro-chat/intro-questions.<nyelv>.md`
...
Ha az 1. szakasz elérhetőség-ellenőrzése sikertelen volt: NE próbálj meg semmilyen más referencia-fájlt letölteni. Hozd létre az AGENTS.md-t inline, kizárólag a jelen promptban lévő tartalom alapján — a 2. szakasz 8 szakaszos struktúrája, minden szakaszhoz rövid tartalom általános tudásodból. Tartsd 200 sor alatt. Hozd létre az `agy/` és `projects/` mappastruktúrát a 3. szakasz szerint.

Mondd el a barátnak explicit módon: *„Nem értem el a kézikönyvet itt: `https://raw.githubusercontent.com/lipi4242/mentat-ai-bootstrap/main/reference/_index.md`. Felállítottam egy minimális verziót. Hálózati kapcsolat kell a sablonokhoz és keretrendszerekhez. A minimális verzió működőképes, de hiányzik belőle a letöltött mélység."*

Aztán indítsd a bemutatkozó beszélgetést a specifikáció sorrendje alapján, általános tudásodból: név → szerep → segítség-területek → személyiség → ágens neve → brain-dump demó → opcionális konnektor.
...
Az ágensed:
1. Ellenőrzi, hogy el tudja-e érni a kézikönyvet (ezt a repót).
...
(TBD — a szélesebb nyilvános megjelenés előtt kerül eldöntésre.)
